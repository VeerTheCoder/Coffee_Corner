      ...
      <div className="bg-black/40 min-h-[400px]">
        <div className="container grid md:grid-cols-3 pb-20 pt-5">
          ...
          <div className="py-8 px-4">
            ...
            <a
              href="#"
              className="inline-block bg-[#3d2517] py-2 px-4 mt-5 text-sm rounded-full relative z-30"
            >
              Visit our Shop
            </a>
          </div>
          ...
          <div className="col-span-2 grid grid-cols-2 sm:grid-cols-3 md:pl-10">
            ...
            <div className="py-8 px-4 col-span-2 sm:col-auto">
              ...
              <div>
                <p className="mb-3">New Ashok Nagar, Delhi, 110096</p>
                <p>+91 9123467210</p>
                ...
                <div className="flex items-center gap-3 mt-6 relative z-30">
                  ...
                  <a href="https://www.linkedin.com/in/virendra-pratap-singh-94713a20a" target="_">
                    <FaLinkedin className="text-3xl hover:text-primary duration-200" />
                  </a>
                  <a href="https://github.com/VeerTheCoder" target="_">
