...
const Hero = () => {
  return (
    <>
      <div className="min-h-[600px] md:min-h-[550px] lg:min-h-[650px] bg-brandDark flex justify-center items-center text-white">
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div className="flex flex-col justify-center gap-6 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1">
              ...
              >
                ...
                <span
                  data-aos="zoom-out"
                  data-aos-delay="300"
                  class="bg-clip-text text-transparent bg-gradient-to-r from-primary/90 to-blurlight font-cursive uppercase"
                >
                  Coffee
                </span>{" "}
                in the city
            ...
            >
              ...
              <div
                data-aos="fade-left"
                className="bg-gradient-to-r from-primary to-secondary p-3 rounded-xl absolute top-16 md:top-10 left-10"
              >
                <h1 className="text-white">Wake Up Your Mind</h1>  
              </div>
              <div
                data-aos="fade-right"
                data-aos-offset="0"
